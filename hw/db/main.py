...
query_create = '''create table students (
                id int,
                name varchar(10),
                age int
            )'''
query_select_all = "select * from members"
query_select_sth = "select name, age from members"
# where 절도 ...
query_select_where = "select name from members where age = 29"
query3 = "insert into members values(1,'jenny',29)"
query_insert = "insert into members values(3,'j',27)"


db = ourDatabase()
# qp = queryParser(query_create)
